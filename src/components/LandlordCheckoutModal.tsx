...
interface LandlordCheckoutModalProps {
  ...
  landlordName: string
  deposit?: number
  onConfirm: (refunds: { depositRefund: number; penalty: number; checkoutDate: string }) => void
}
        ...
        <div className="sticky top-0 bg-white p-4 border-b border-gray-100">
          ...
          <div className="bg-gray-50 rounded-xl p-3 text-sm space-y-1">
            ...
            <div className="flex justify-between font-bold border-t pt-1 mt-1">
              <span>合计退还</span>
              <span>¥{(parseFloat(depositRefund) || 0).toFixed(2)}</span>
            </div>
          </div>
          ...
          <div className="flex gap-3">
            ...
            <button type="button" onClick={() => {
              ...
              onConfirm({ depositRefund: d, penalty: p, checkoutDate })
